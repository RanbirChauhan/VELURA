  ...
  return (
    <div className='flex flex-col sm:flex-row border border-gray-400 rounded-tr-2xl '>
        ...
        <div className='w-full sm:w-1/2 overflow-hidden'>
            <img src={RandomImage()} alt="Bestsellers" className='w-full h-150 object-cover rounded-tr-2xl shadow-lg transition-transform duration-300 ease-in-out' loading="lazy" />
        </div>
    </div>
  )
}
