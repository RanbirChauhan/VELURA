    ...
    <div className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-top'>
          ...
          <div className='flex flex-col gap-4 w-full sm:max-w-[480px]'>
              ...
              <div className='flex gap-3 '>
                ...
                <input className='border border-gray-400 rounded py-1.5 px-3.5 w-full' type="email" placeholder='Enter your Email Address'/>
              ...
              <div className='flex gap-3 '>
                <input className='border border-gray-400 rounded py-1.5 px-3.5 w-full' type="number" placeholder='PINCODE'/>
          ...
          <div className='mt-8'>
                ...
                <div className='w-full text-end mt-8'>
                    <button onClick={() => navigate('/orders')} className='bg-black text-white px-8 py-3 text-sm rounded-full'>PLACE ORDER</button>
                </div>
                </div>
          </div>
    </div>
